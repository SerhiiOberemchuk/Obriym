declare module "ga-gtag" {
  ...
  export function install(trackingId: string, additionalConfigInfo?: Record<string, unknown>): void;

  export function gtag(command: "consent", action: "update", params: GtagConsentUpdate): void;
