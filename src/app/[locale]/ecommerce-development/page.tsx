...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildMetadata(await buildServiceMetadataInput("ecommerceDevelopment", locale as Locale));
}
...
export default async function EcommerceDevelopmentPage({ params }: PageProps) {
  ...
  return <ServicePage service="ecommerceDevelopment" locale={locale as Locale} />;
}
